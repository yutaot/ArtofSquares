...
class QTree {
 ...
 public:
  ...
  void writeHelper(PNG & im, PNG & imNoFrame, Node* root);
 ...
 private:
  ...
  PNG imNoFrame; // image without the frame
  ...
  void balanceSplit(Node * node);

  void findAndRemoveFromQ(Node * node);
  ...
  Node * findNode(Node * t, pair<int, int> find, Node * node);
