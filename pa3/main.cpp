...
int main()
{
  ...
  t1=t4;
  cout<<__LINE__<<endl;
  t1.write("images/out-geoEq_t1.png");
  t4.write("images/out-geoEq_t4.png");
  cout<<__LINE__<<endl;
  ...
  //i want to test some of my input images
  // PNG im6;
  // im6.readFromFile("images/deku.png");
  // QTree t6(im6,5000,RGBAPixel(100,100,100));
  // t6.write("images/out-deku.png");
  //
  // // use image to build a balanced QTree
  // QTree t6b(im6,5000,RGBAPixel(100,100,100),true);
  // t6b.write("images/out-dekuBal.png");
